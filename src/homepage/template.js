  ...
  module.exports = function (pictures){
    ...
    <div class = "row">
      <div class = "col s12 m10 offset-m1 18 offset-12 center-align">
        <form enctype="multipart/form-data" class="form-upload" id="formUpload">
          ...
          <button id="btnCancel" type="button" class="btn btn-flat red hide" onclick=${cancel}><i class="fa fa-times" aria-hidden="true"></button>
        </form>
      </div>
    </div>
    <div class="row">
